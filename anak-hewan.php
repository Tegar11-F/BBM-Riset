...
=======
                            ...
                            $totalRowsQuery = "SELECT COUNT(*) FROM `kata_khusus` WHERE jenis='anak hewan' AND `madura` LIKE '%'";
                            ...
                            $query = "SELECT `madura`, `indonesia` FROM `kata_khusus` WHERE jenis='anak hewan' AND `madura` LIKE '%' ORDER BY RAND() LIMIT $offset, $itemsPerPage";
