    ...
    <div id="right-panel" class="right-panel">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <h3>
                        Berdasarkan Pedoman Umum Ejaan Bahasa Madura yang disempurnakan maka terdapat beberapa aturan
                        sebagai berikut :
                    </h3>
                    <br>
                    ...
                    <h4>5. Aksara peluncur /w/ y/ glotal/ yang timbul karena proses afiksasi, tidak ditulis seperti :
                    </h4>
                    <ul>
                        <li>
                    ...
                    <h4>6. Aksara peluncur /w/ y/ glotal/ yang timbul pada kata asal, tetap ditulis seperti contoh :
                    </h4>
                    <ul>
                        <li>
