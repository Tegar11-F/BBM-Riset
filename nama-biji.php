                ...
                <div style="height:430px;" class="col-lg-12">
                    <div class="presentation"
                        ...
                        <div class="slides">
                            ...
                            $totalRowsQuery = "SELECT COUNT(*) FROM `kata_khusus` WHERE jenis='nama biji' AND `madura` LIKE '%'";
                            ...
                            $query = "SELECT `madura`, `indonesia` FROM `kata_khusus` WHERE jenis='nama biji' AND `madura` LIKE '%' ORDER BY RAND() LIMIT $offset, $itemsPerPage";
