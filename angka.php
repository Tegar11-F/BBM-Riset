                ...
                <div style="height:430px;" class="col-lg-12">
                    <div class="presentation"
                        ...
                        <div class="slides">
                            ...
                            $totalRowsQuery = "SELECT COUNT(*) FROM `kamus` WHERE keterangan='angka' AND `madura` LIKE '%'";
                            ...
                            $query = "SELECT `madura`, `indonesia` FROM `kamus` WHERE keterangan='angka' AND `madura` LIKE '%' ORDER BY RAND() LIMIT $offset, $itemsPerPage";
