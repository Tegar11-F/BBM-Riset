                                ...
                                <section class="middle">
                                    <div class="table-responsive" id="coba">
                                        <table class="table table-bordered table-hover table-striped"
                                            ...
                                            <tbody>
                                                <?php
                                        $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'a%' ORDER BY RAND() LIMIT 5;");
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'd%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'e%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                                                <td><button type="button" class="btn btn-success"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'f%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                                                <td><button type="button" class="btn btn-info"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'g%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                                                <td><button type="button" class="btn btn-warning"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'h%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                                                <td><button type="button" class="btn btn-danger"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'i%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                                                <td><button type="button" class="btn btn-success"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'j%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-info"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'k%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                                                <td><button type="button" class="btn btn-warning"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'l%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                                                <td><button type="button" class="btn btn-danger"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                $q = mysqli_query($koneksi, "SELECT `madura`,`indonesia` FROM `kamus` WHERE `madura` LIKE 'm%' ORDER BY RAND() LIMIT 5;");
                                while ($h = mysqli_fetch_array($q)) {
                                ?>
                                            <tr>
                                                <td><button type="button" class="btn btn-success"
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'n%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-info"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'o%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-warning"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'p%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-danger"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'r%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-success"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 's%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-info"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 't%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-warning"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'u%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-danger"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'v%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-success"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'w%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-info"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'y%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-warning"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
                            ...
                            <section class="middle">
                                <div class="table-responsive" id="coba">
                                    <table class="table table-bordered table-hover table-striped"
                                        ...
                                        <tbody>
                                            <?php
                                        $q = mysqli_query($koneksi, "select `madura`,`indonesia` from `kamus` where `madura` like 'z%' order by rand() limit 5;");
                                        while($h = mysqli_fetch_array($q)){?>
                                            <tr>
                                                <td><button type="button" class="btn btn-danger"
                                                        onClick=play("<?php echo $h[0];?>")><?php echo $h[0];?></button>
